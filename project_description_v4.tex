...
\alanheading{RFI Excision} As part of our normal operational
...
\alanheading*{Molecular Line Surveys} Survey speeds of regions that are
...
\alanheading*{DSP Capabilities} We will create additional basic EDK
...
%many upcoming radio astronomy instruments, the high-speed DACs
%(Xilinx’s integrated DACs have so far been significantly faster than
%their ADCs) will allow better full-system tests.  For example,
%standard digitized data sets (generated from real astronomical data or
...
%for reliable, reproducible end-to-end tests of RFI excision algorithms
%(see \S\ref{sec:rfi_excision}).
